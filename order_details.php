      ...
      <div class="collapse navbar-collapse mmm askjd" id="myNavbar">
        <ul class="nav navbar-nav navbar-right iii">
           <li><a href="index.php" class="asek out_line acc_col">HOME</a></li>
            ...
            <li class="dropdown">
          <a href="#" class="dropdown-toggle toggle_radius cart_ic_font acc_col" data-toggle="dropdown" role="button" aria-expanded="false"> <span class="glyphicon glyphicon-shopping-cart"></span> 7<span class="caret"></span></a>
          <ul class="dropdown-menu dropdown-cart toggle_radius drop_back1" role="menu">
              <li>
                  <span class="item">
                    ...
                    <span class="item-right">
                        <button class="btn btn-xs cap_mar1"><img src="image/pencil.png" alt=""><button class="btn btn-xs btn-danger pull-right">x</button>
                    </span>
                </span>
              </li>
              <li>
              ...
              <li class="divider"></li>
              <li><a class="text-center order_weight " href="cart.php"><button type="button" class="btn btn-danger text-center">View All</button></a></li>
          </ul>
        </li>
        
         <li class="dropdown">
          <a class="dropdown-toggle user_mar_font toggle_radius cart_ic_font acc_col" data-toggle="dropdown" href="#"><i class="fa fa-user" aria-hidden="true"></i>
            <span class="caret"></span></a>
          <ul class="dropdown-menu toggle_radius drop_back1">
            <li><a href="login.html" class="drop_back">Login/Register</a></li>
            <li><a href="my_account.html" class="drop_back">My Account</a></li>
            <li><a href="my_order.html" class="drop_back">My Order</a></li>
             <li><a href="#" class="drop_back">Logout</a></li>
          </ul>
        </li>
      </ul>
    </div>
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="panel panel-default mar_bot">
                     <div class="panel-heading pad_remv">
                        ...
                        <li class=" my_order_ui panal_mar1"><img src="image/list.png" class="order_height_1">&nbsp <span class="order_details_font">Order No</span><span>:&nbsp W2333GF</span></li>
                        <li class=" panal_mar  my_order_ui"><img src="image/tag1.png" class="order_height_1">&nbsp <span class="order_details_font">Total Price</span><span>:&nbsp $544</span></li>
                         <li class=" panal_mar  my_order_ui"><img src="image/calendar.png" class="order_height_1"> &nbsp<span class="order_details_font">Order Date</span><span>:&nbsp 02/05/2018</span></li>
                         <li class=" panal_mar  my_order_ui"><img src="image/pie-chart-in-a-rounded-square.png" class="order_height_1"> &nbsp<span class="order_details_font">Status</span><span>:&nbsp In Stock</span></li> 
                        </ul>
                     </div>  
                  </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 thank_you_margin1">
              <div class="table-responsive">          
                  <table class="table table-bordered table-striped table-hover">
                    <thead>
                       <tr class="order_back">
                          <th colspan="3"><h5 class="cart_total1">Order Details</h5></th>
                       </tr>
                       <tr>
                   ...
                   <tbody>
                    <tr>
                       <td> <p class="order_weight thank_padd">SONY LED 32 inch</p></td>
                       <td class="thank_padd1">1</td>
                      <td class="thank_padd1">$199.00</td>
                   </tr>
                  <tr>
                       <td> <p class="order_weight thank_padd">SONY XPERIA XA ULTRA</p></td>
                       <td class="thank_padd1">2</td>
                      <td class="thank_padd1">$299.00</td>
                  </tr>
                   <tr>
                       <td> <p class="order_weight thank_padd">RENULT DUSTER</p></td>
...
<div class="container-fluid">
  <div class="row">
      <div class="col-md-12 col-md-12 col-xs-12 text_center1 nopadd video_sec1">
       <div class="col-md-3 col-sm-12 col-xs-12 text-center asddf clearfix"> 
             <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                  <h5 class="qaxds">VIENNA <img src="image/cropped-Logo-1.png" height="20"></h5>
                  <p class="mar-le2">
 ...
 <div class="col-md-3 col-sm-12 col-xs-12 text-center asddf1 clearfix">
       ...
       <div class="col-md-12 col-sm-12 col-xs-12 text-center pad11 mar-ico">
              <p><a class="dhhkd1 let_spce" href="#myPage"><i class="fa fa-chevron-circle-right icon-padd1" aria-hidden="true"></i>&nbsp HOME</a></p>
              <p><a class="dhhkd1 let_spce" href="#myPage">
              <i class="fa fa-chevron-circle-right icon-padd1" aria-hidden="true"></i>&nbsp ABOUT</a></p>
              <p><a class="dhhkd1 let_spce" href="#myPage"><i class="fa fa-chevron-circle-right icon-padd1" aria-hidden="true"></i>&nbsp MENU</a></p>
              <p><a class="dhhkd1 let_spce" href="#myPage"><i class="fa fa-chevron-circle-right icon-padd1" aria-hidden="true"></i>&nbsp GALLARY</a></p>
              <p><a class="dhhkd1 let_spce" href="#myPage"><i class="fa fa-chevron-circle-right icon-padd1" aria-hidden="true"></i>&nbsp RESERVATION</a></p>
              <p><a class="dhhkd1 let_spce" href="#myPage"><i class="fa fa-chevron-circle-right icon-padd1" aria-hidden="true"></i>&nbsp CONTACT US</a></p> 
       </div>
 </div>
   ...
   <div class="col-md-12 col-sm-12 col-xs-12 text-center">
       ...
       <div class="col-md-6 col-sm-6 col-xs-6 map_hight">
          <div id="" class="col-md-12 col-sm-12 col-xs-12 regs qbca">
               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14736.2936651799!2d88.42520676582065!3d22.57635731172786!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a0275b020703c0d%3A0xece6f8e0fc2e1613!2sSector+V%2C+Salt+Lake+City%2C+Kolkata%2C+West+Bengal!5e0!3m2!1sen!2sin!4v1524148893398" frameborder="0" style="border:0" allowfullscreen class="regs"></iframe>
          </div>
       </div>
